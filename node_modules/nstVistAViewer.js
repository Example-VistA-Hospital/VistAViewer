...
module.exports = {
	...
	onMessage: {
		...
		'getPatchSummary' : function(params, ewd) {
			...
			patch.ddCounter = vista.di.getRecordsCounter(root); // number of DDs 
		...
		'getDDDefinition' : function(params, ewd) {
			...
			var fileName = vista.di.fileName(pFile, ewd);
			var detail = vista.di.recordByIEN(1, pFile+',', "**", "ER", ewd);	// get External values and field names
			ewd.sendWebSocketMsg({
					type: 'displayDDDefinition',
					params: {'detail': detail.result, 'file' : pFile, 'fileName' : fileName }
				});
			return;
		},
