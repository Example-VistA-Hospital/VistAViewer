...
module.exports = {
	...
	onMessage: {
		...
		'retrieveGlobalArray' : function(params, ewd) {
			var pGlobalName= params.global;
			var pCallback = params.callback;
			...
			var tempGlobal = new ewd.mumps.GlobalNode(root,indices);
			var result = tempGlobal._getDocument();
			ewd.sendWebSocketMsg({
					type: pCallback,
